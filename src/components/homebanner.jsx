      ...
      <div className="w-full bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2">
            ...
            <div className="bg-[#00BFA5] p-8 md:p-16 flex flex-col justify-center order-1 md:order-2">
              ...
              <button className="text-[#00BFA5] bg-white px-4 md:px-6 py-2 md:py-3 rounded text-base font-medium w-fit hover:bg-opacity-90 transition-all duration-200">
                Get Support
              </button>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto py-20 px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-16">
            {/* Left Title */}
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-[#004D43] leading-tight">
                Diagnosis Per Life Stage
              </h2>
            </div>
  
            {/* Right Content */}
            <div className="lg:col-span-2 text-base md:text-lg text-[#004D43] space-y-6">
              <p>
